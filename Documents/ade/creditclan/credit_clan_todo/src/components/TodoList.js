        ...
        <div className='row'>
            ...
            <div>
                ...
                <div className='menu'>
                    ...
                    <h5 className='item' onClick={getAll}>All</h5>
                    <h5 className='item' onClick={getActive}>Active</h5>
                    <h5 className='item' onClick={getCompleted}>Completed</h5>
                    <h5 className='item' onClick={clearCompleted}>Clear completed</h5>
                </div>
            </div>
